...
class MyAppState extends State<MyApp> {
                        ...
                        child: Column(
                          children: [
                            ...
                            ElevatedButton(
                                ...
                                onPressed: () => _ndefWriteAppLaunch(context)),
                          ],
                        ),
                      ),
                    ],
  ...
  void _ndefWriteWhatsApp(context) {
    ...
    String phoneNumber =
        "+923355105223"; // Replace with the actual phone number

    // Define the WhatsApp message
    String message =
        "Hello, this is a WhatsApp message."; // Replace with the desired message
  ...
  void _ndefWriteWifi(context) {
    ...
    String securityType =
        "WPA"; // Replace with the actual security type (e.g., "WEP", "WPA", "WPA2")
    ...
    NdefRecord wifiRecord = NdefRecord.createMime(
        "application/vnd.wfa.wsc", Uint8List.fromList(wifiConfig.codeUnits));
  ...
  void _ndefWriteEmail(context) {
    ...
    NdefRecord emailRecord = NdefRecord.createMime(
        "message/rfc822", Uint8List.fromList(emailAddress.codeUnits));
  ...
  void _ndefWriteLocation(context) {
    ...
    double latitude = -90 +
        (180 * (Random().nextDouble())); // Random latitude between -90 and 90
    double longitude = -180 +
        (360 *
            (Random().nextDouble())); // Random longitude between -180 and 180
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              CachedNetworkImage(
                imageUrl:
                    'https://assets-v2.lottiefiles.com/a/a68e4064-1166-11ee-a842-97da89eaf7c1/pRpPDA70yq.gif',
                width: 100,
                height: 100,
              ),
